# Adding yelb application

Create new file in `stacks` directory called `application.py`

Insert this code to create application:
...
Change the `app.py` file to add the application stack definition and passing some configuration to it.
...
This would create an application and allow us to see it via LoadBalancer endpoint.

---

### Next

- [Configuring App Mesh](./Configuring%20App%20Mesh.MD)